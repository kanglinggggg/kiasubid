...
This folder intentionally contains no scored `.json` case in the frozen repository. A teammate who
has not tuned the production prompts can copy the `.json.example` template, add genuinely unseen
case data, and run:
